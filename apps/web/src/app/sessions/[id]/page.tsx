    ...
    <div className="h-full flex flex-col">
      ...
      {codexLoginMode && (
        <div className="shrink-0 px-6 py-3 border-b border-primary/20 bg-primary/5 text-sm">
          ...
          <code>codex login</code>, keeps a login transcript for Setup/Settings to read, and should
          stay open until Optio reports that the shared auth was imported.
        </div>
      )}
